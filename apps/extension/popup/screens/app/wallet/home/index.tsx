...
import { usePreferencesQuery } from '../../../../hooks/ui-service';
...
export function WalletHomeTab() {
  ...
  const { navigateToSend, navigateToSwap } = useWalletActionsNavigation();
  ...
  const handleChangePreferences = async (input: Preferences) => {
    await walletService.setPreferences(input);
