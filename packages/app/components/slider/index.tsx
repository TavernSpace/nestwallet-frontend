...
export class Slider extends PureComponent<SliderProps, SliderState> {
  constructor(props: SliderProps) {
    ...
    this.state = {
      ...
      values: updateValues({
        values: normalizeValue(this.props, this.props.value),
      }),
    };
  }
  ...
  _getRawValues(
    values:
      ...
      | Array<Animated.AnimatedInterpolation<number | string>>,
  ) {
    // @ts-ignore
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          {renderMaximumTrackComponent ? renderMaximumTrackComponent() : null}
        </View>
        ...
        >
          {renderMinimumTrackComponent ? renderMinimumTrackComponent() : null}
        </Animated.View>
        {renderTrackMarkComponent &&
        ...
        {interpolatedThumbValues.map((value, i) => (
          <Animated.View
            key={`slider-thumb-${i}`}
            style={[
              renderThumbComponent ? styles.renderThumbComponent : styles.thumb,
              renderThumbComponent
                ? {}
                : {
