//code taken from: https://github.com/metaplex-foundation/mpl-bubblegum/blob/main/clients/js-solita/src/generated/instructions/transfer.ts
//the function I need is only in the js package but not the typescript package for some reason so I just copied it over
 ...
 * @category generated
 */
export function createBubblegumTransferInstruction(
